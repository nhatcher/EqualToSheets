class PyCalcModel:
    ...
    def evaluate_with_error_check(self) -> list[str]: ...
    ...
    def set_cell_empty(self, sheet: int, row: int, column: int) -> None: ...
