...
from .models import License, LicenseDomain


def is_license_key_valid_for_host(license_key: str, host: str):
    ...
    return (
        license.email_verified and (
            # exact mach
            LicenseDomain.objects.filter(license=license, domain=domain).exists() or
