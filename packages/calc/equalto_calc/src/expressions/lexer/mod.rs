...
//! # Examples:
//! ```
//! use equalto_calc::expressions::lexer::{Lexer, LexerMode};
//! use equalto_calc::expressions::token::{TokenType, OpCompare};
//! use equalto_calc::locale::get_locale;
//! use equalto_calc::language::get_language;
//!
